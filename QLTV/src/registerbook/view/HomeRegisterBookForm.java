...
public class HomeRegisterBookForm extends javax.swing.JFrame {
                                ...
                                if (amount <= 3) {
                                    ...
                                    if (appointDate.getTime() > dateNow.getTime()) {
                                        ...
                                        var rb = new RegisterBook(st.getStudentId(), book.getBookId());
                                         ArrayList<RegisterBook> rbnew;
                                        rbnew = new ArrayList<>();
                                         rbnew = checkReBookId(listRb,st.getStudentId(),book.getBookId());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (listRb.size() > 0) {
            edit = tableRegisterBook.getSelectedRow();
        if (edit != -1) {
                String trangthai = (String) tableRegisterBook.getValueAt(edit, 7);
                ...
                edit = -1;        
                    ...
                    JOptionPane.showMessageDialog(rootPane, "đã trả thì đừng mơ đòi sửa");
                }
    ...
    public static ArrayList<RegisterBook> checkReBookId(ArrayList<RegisterBook> listrb, String studentId1,String bookId1) {
        ArrayList<RegisterBook> listtamthoi ;
        listtamthoi = new ArrayList<>();
        for (var e : listrb) {
            if (e.getStudentId().equalsIgnoreCase(studentId1)&&e.getBookId().equalsIgnoreCase(bookId1)) {
                listtamthoi.add(e);
    ...
    // 1 đống danh sach có trả rồi và 1 chưa trar hoac tra roi het 
    //hàm bôolen (list)
    //for (e:list)
    //if(e.trang thai =="chua tra" )
    //return true 
    ...
    private void showRefreshListRb() {
        int stt = 1;
        tableModelRb.setRowCount(0);
        ArrayList<RegisterBook> listRbnew;
        listRbnew=new ArrayList<>();
        drb.readRegisterBookSQL(listRbnew);
        listRb = listRbnew;
        for (var e : listRb) {
            SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
            SimpleDateFormat dfAppoint = new SimpleDateFormat("dd/MM/yyyy");
