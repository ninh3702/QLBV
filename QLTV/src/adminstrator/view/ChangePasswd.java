...
public class ChangePasswd extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 130, 50));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("Mật Khẩu Mới:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 210, 170, 50));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Nhập Lại Mật Khẩu Mới:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 200, 50));
        ...
        getContentPane().add(btnOk, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 390, 150, 30));
        ...
        getContentPane().add(btnclose, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 390, 150, 30));

        txtpasswdOld.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(txtpasswdOld, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 150, 280, 40));

        txtpasswdNew1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(txtpasswdNew1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 220, 280, 40));

        txtpasswdNew2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(txtpasswdNew2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, 280, 40));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel5.setText("Đổi Mật Khẩu");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 250, 50));
